...
console.log(threeLevelTree.max(threeLevelTree.root))


console.log(twoLevelTree.minRecursive(twoLevelTree.root))
console.log(threeLevelTree.minRecursive(threeLevelTree.root))
